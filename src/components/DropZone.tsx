    ...
    <div
      ...
      className={cn(
        ...
        isDragActive
          ...
          : "border-gray-300 hover:border-leaf-300",
      ...
      {preview ? (
        <div className="relative h-full w-full">
          <button
            ...
            className="absolute right-2 top-2 z-10 rounded-full bg-white p-1 shadow-lg transition-transform hover:scale-110"
          >
        ...
        <div className="flex h-full flex-col items-center justify-center gap-4 text-center">
          <Upload
            className={cn(
              ...
              isDragActive ? "text-leaf-400" : "text-gray-400"
            )}
          />
